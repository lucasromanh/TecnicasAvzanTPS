...
public class OperacionesSegunRango {
    public static void main(String[] args) {
        ...
        if (numero >= 0 && numero <= 20) {
            ...
            if (sumaDigitos <= 10) {
                System.out.println("Luego de restar 45 a " + numero + " obtuvimos " + resultado + " y sumando sus dígitos tenemos " + sumaDigitos + ".");
            } else {
                System.out.println("Luego de restar 45 a " + numero + " obtuvimos " + resultado + ".");
            }
        } else {
